    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 to-slate-900 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8 animate-fade-in">
          ...
          <p className="text-slate-400">Login to your typing account</p>
        </div>
        ...
        <div className="bg-slate-800/90 rounded-2xl border border-slate-700 shadow-2xl p-8 backdrop-blur-sm animate-slide-up">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3 px-4 rounded-xl font-medium text-slate-900 bg-emerald-500 hover:bg-emerald-600 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 flex items-center justify-center gap-2 shadow-lg hover:shadow-emerald-500/20"
            >
              {loading ? (
                <>
          ...
          <div className="space-y-3">
            ...
            <button
              type="button"
              disabled
              className="w-full py-3 px-4 rounded-xl font-medium text-slate-100 bg-slate-700/50 border border-slate-600 hover:bg-slate-700 disabled:cursor-not-allowed transition-all duration-200 flex items-center justify-center gap-2"
            >
